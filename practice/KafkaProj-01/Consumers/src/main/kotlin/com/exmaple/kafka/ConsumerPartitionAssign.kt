...
class ConsumerPartitionAssign {
    val logger: Logger = LoggerFactory.getLogger(ConsumerPartitionAssign::class.java.name)
    ...
    companion object fun main(args: Array<String>) {
        ...
        val topicPartition : TopicPartition = TopicPartition(topicName, 0)
...
//        kafkaConsumer.subscribe(listOf(topicName))
        ...
        // 같은 group 에서는 commit 을 주의해서 할 필요 있음!
